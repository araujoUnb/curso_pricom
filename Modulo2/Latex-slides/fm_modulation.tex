...
\begin{center}
\includegraphics[width=\figHalf]{figures/cap4/fm_bessel_functions.pdf}
\end{center}

\textbf{Observe:} $J_0(\beta)$ decresce com $\beta$ (potência sai da portadora para bandas laterais).

Para $\beta \approx 2.4$: $J_0 = 0$ $\rightarrow$ portadora desaparece!
...
\begin{center}
\includegraphics[width=\figFull]{figures/cap4/fm_spectrum_beta.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\figFull]{figures/cap4/fm_nbfm_vs_wbfm.pdf}
\end{center}

\textbf{NBFM} ($\beta \ll 1$): espectro similar a AM, poucas bandas laterais.

\textbf{WBFM} ($\beta \gg 1$): espectro largo, muitas bandas laterais, melhor SNR.
...
\begin{center}
\includegraphics[width=\figFull]{figures/cap4/fm_discriminator.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\figFull]{figures/cap4/pll_analysis.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\figFull]{figures/cap4/pll_locking.pdf}
\end{center}

\textbf{Observe:} O VCO converge para a frequência de entrada -- após o travamento, $v_c(t) \propto m(t)$.
...
\begin{center}
\includegraphics[width=\figFull]{figures/cap4/superheterodyne_conversion.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\figFull]{figures/cap4/superheterodyne_image.pdf}
\end{center}

O filtro RF deve rejeitar a frequência imagem antes do mixer.
