...
% --- Título e Subtítulo ---
\newcommand{\tituloApresentacao}{Modulação AM: AM Convencional}
\newcommand{\subtituloApresentacao}{Capítulo 4a: DSB-LC, Detector de Envelope e Eficiência}
