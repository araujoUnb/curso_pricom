...
% --- Título e Subtítulo ---
\newcommand{\tituloApresentacao}{Modulação Angular: FM e PM}
\newcommand{\subtituloApresentacao}{Capítulo 4b: Modulação em Frequência, PLL e Receptor Superheterodino}
