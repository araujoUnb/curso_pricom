...
com $m(t)$ normalizado tal que $\max|m(t)| = 1$ e $\mu$ o índice de modulação.

\onslide<2->{
\textbf{Decomposição:}
\[
s(t) = \underbrace{A_c \cos(2\pi f_c t)}_{\text{portadora}} + \underbrace{A_c \mu m(t) \cos(2\pi f_c t)}_{\text{DSB-SC}}
\]
}
...
Com $m(t)$ normalizado tal que $\max|m(t)| = 1$, o índice de modulação $\mu$ mede a profundidade da modulação:

\[
\boxed{s(t) = A_c[1 + \mu m(t)] \cos(2\pi f_c t)}
\]

\textbf{Envelope:} $A(t) = A_c[1 + \mu m(t)]$
...
\begin{center}
\includegraphics[width=\figFull, height=0.6\textheight, keepaspectratio]{figures/cap4/supermod_tempo.pdf}
\end{center}

\vspace{-0.2cm}
Para $\mu > 1$, o envelope $1 + \mu\,m(t)$ fica negativo $\rightarrow$ a portadora \textbf{inverte a fase} com salto de $180^\circ$.
...
\begin{center}
\includegraphics[width=\figFull, height=0.6\textheight, keepaspectratio]{figures/cap4/supermod_detector.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\figFull, height=0.6\textheight, keepaspectratio]{figures/cap4/supermod_espectro_rf.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\figFull, height=0.6\textheight, keepaspectratio]{figures/cap4/supermod_espectro_bb.pdf}
\end{center}
...
\only<1>{
\[
s(t) = \underbrace{A_c \cos(2\pi f_c t)}_{\text{portadora}} + \underbrace{A_c \mu m(t) \cos(2\pi f_c t)}_{\text{bandas laterais}}
\]

\textbf{Transformada de Fourier:}
\[
S(f) = \underbrace{\frac{A_c}{2}[\delta(f\!-\!f_c) + \delta(f\!+\!f_c)]}_{\text{portadora}} + \underbrace{\frac{A_c \mu}{2}[M(f\!-\!f_c) + M(f\!+\!f_c)]}_{\text{bandas laterais}}
\]
}
...
\[
P_s = \underbrace{\frac{A_c^2}{2}}_{P_c \text{ (portadora)}} + \underbrace{\frac{A_c^2 \mu^2 P_m}{2}}_{P_{sb} \text{ (bandas laterais)}}
\]

\textbf{Eficiência:} Fração da potência que carrega informação
\[
\boxed{\eta = \frac{P_{sb}}{P_s} = \frac{\mu^2 P_m}{1 + \mu^2 P_m}}
\]
...
\begin{center}
\begin{tikzpicture}[>=latex, line width=0.9pt, scale=1.0]

% ---------- entrada ----------
\draw (-1.4,0) node[left] {$s(t)$} -- (0.6,0);
% forma de onda AM na entrada
\begin{scope}[shift={(-1.5,1.3)}, line width=0.7pt]
  \draw[gray!50] (-0.1,0) -- (2.0,0);
  \draw[unbprimary!75, smooth] plot[domain=0:1.9, samples=140]
    (\x, {(1+0.6*sin(3.3*\x r))*0.3*cos(30*\x r)});
  \draw[unbaccent, dashed, smooth] plot[domain=0:1.9, samples=60]
    (\x, {(1+0.6*sin(3.3*\x r))*0.3});
  \node[below, font=\scriptsize, gray!70] at (0.95,-0.45) {AM modulado};
\end{scope}

% ---------- diodo ----------
\filldraw[fill=unbprimary!15, draw=unbprimary]
  (0.6,-0.3) -- (0.6,0.3) -- (1.25,0) -- cycle;
\draw[unbprimary, line width=1.4pt] (1.25,-0.3) -- (1.25,0.3);
\node[above, font=\footnotesize] at (0.93,0.34) {Diodo};
\draw (1.25,0) -- (4.0,0);

% ---------- capacitor ----------
\draw (2.1,0) -- (2.1,-0.6);
\draw[line width=1.2pt] (1.78,-0.6) -- (2.42,-0.6);
\draw[line width=1.2pt] (1.78,-0.82) -- (2.42,-0.82);
\draw (2.1,-0.82) -- (2.1,-1.5);
\node[left, font=\small] at (1.72,-0.71) {$C$};

% ---------- resistor ----------
\draw (3.3,0) -- (3.3,-0.45);
\draw[fill=white] (3.06,-0.45) rectangle (3.54,-1.05);
\node[font=\small] at (3.3,-0.75) {$R$};
\draw (3.3,-1.05) -- (3.3,-1.5);

% ---------- terra ----------
\draw (2.1,-1.5) -- (3.3,-1.5);
\draw (2.7,-1.5) -- (2.7,-1.72);
\draw (2.42,-1.72) -- (2.98,-1.72);
\draw (2.53,-1.86) -- (2.87,-1.86);
\draw (2.64,-2.0) -- (2.76,-2.0);

% ---------- saida ----------
\fill (4.0,0) circle (1.6pt);
\draw[->] (4.0,0) -- (5.0,0) node[right] {$y(t)$};
% envelope recuperado na saida
\begin{scope}[shift={(3.5,1.3)}, line width=0.7pt]
  \draw[gray!50] (-0.1,0) -- (2.0,0);
  \draw[unbaccent, line width=1.1pt, smooth] plot[domain=0:1.9, samples=60]
    (\x, {(1+0.6*sin(3.3*\x r))*0.3});
  \node[below, font=\scriptsize, gray!70] at (0.95,-0.45) {envelope $\propto m(t)$};
\end{scope}
