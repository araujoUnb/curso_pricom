...
# Title: Exemplo 01 - Distorcao de Amplitude
# Author: Curso PriCom - UnB
# Description: Exemplo 01 - Distorcao de Amplitude em Canal LTI
...
class exemplo_01_distorcao_amplitude(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Exemplo 01 - Distorcao de Amplitude", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Exemplo 01 - Distorcao de Amplitude")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "exemplo_01_distorcao_amplitude")
        ...
        labels = ['Original (sem distorcao)', 'Distorcido (apos canal)', 'Signal 3', 'Signal 4', 'Signal 5',
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter.set_taps(firdes.low_pass(1, self.samp_rate, self.cutoff, 500, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=exemplo_01_distorcao_amplitude, options=None):
