...
# Title: Exemplo 07 - PSD e Filtragem de Ruido
# Author: Curso PriCom - UnB
# Description: PSD e Filtragem de Ruido
...
class exemplo_07_psd_ruido(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Exemplo 07 - PSD e Filtragem de Ruido", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Exemplo 07 - PSD e Filtragem de Ruido")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "exemplo_07_psd_ruido")
        ...
        self.qtgui_time_sink = qtgui.time_sink_f(
            2048, #size
            samp_rate, #samp_rate
            "Tempo - Ruido Branco vs Filtrado", #name
            2, #number of inputs
            None # parent
        )
        ...
        labels = ['Ruido Branco', 'Ruido Filtrado (LPF 2kHz)', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_freq_sink = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            "PSD - Ruido Branco vs Filtrado", #name
            2,
            None # parent
        )
        ...
        labels = ['Ruido Branco', 'Ruido Filtrado (LPF 2kHz)', '', '', '',
            '', '', '', '', '']
        widths = [2, 2, 1, 1, 1,
            1, 1, 1, 1, 1]
        colors = ["blue", "red", "green", "black", "cyan",
        ...
        self.analog_noise_source = analog.noise_source_f(analog.GR_GAUSSIAN, 1, 0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_noise_source, 0), (self.blocks_throttle, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter.set_taps(firdes.low_pass(1, self.samp_rate, 2000, 500, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=exemplo_07_psd_ruido, options=None):
