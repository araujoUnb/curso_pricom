...
# Title: Exemplo 04 - Butterworth Ordens 1, 2, 4, 8
# Author: Curso PriCom - UnB
# Description: Efeito da Ordem do Butterworth
...
class exemplo_04_butterworth_ordens(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Exemplo 04 - Butterworth Ordens 1, 2, 4, 8", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Exemplo 04 - Butterworth Ordens 1, 2, 4, 8")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "exemplo_04_butterworth_ordens")
        ...
        self.qtgui_time_sink = qtgui.time_sink_f(
            2048, #size
            samp_rate, #samp_rate
            "Tempo - Efeito da Seletividade", #name
            3, #number of inputs
            None # parent
        )
        self.qtgui_time_sink.set_update_time(0.10)
        self.qtgui_time_sink.set_y_axis(-4, 4)
        ...
        labels = ['Original', 'LPF (trans. larga)', 'LPF (trans. estreita)', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_freq_sink = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            "Espectro - Efeito da Seletividade", #name
            3,
            None # parent
        )
        ...
        labels = ['Original', 'LPF (trans. larga)', 'LPF (trans. estreita)', '', '',
            '', '', '', '', '']
        widths = [2, 2, 2, 1, 1,
            1, 1, 1, 1, 1]
        colors = ["blue", "red", "green", "black", "cyan",
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.lpf_n4 = filter.fir_filter_fff(
            1,
            firdes.low_pass(
                1,
                samp_rate,
                ...
                window.WIN_HAMMING,
                6.76))
        self.lpf_n1 = filter.fir_filter_fff(
            1,
            firdes.low_pass(
                1,
                samp_rate,
        ...
        self.cos_3000 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 3000, 1, 0, 0)
        self.cos_1500 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1500, 1, 0, 0)
        ...
        self.connect((self.blocks_throttle, 0), (self.lpf_n1, 0))
        self.connect((self.blocks_throttle, 0), (self.lpf_n4, 0))
        self.connect((self.blocks_throttle, 0), (self.qtgui_freq_sink, 0))
        self.connect((self.blocks_throttle, 0), (self.qtgui_time_sink, 0))
        self.connect((self.cos_1500, 0), (self.blocks_add, 1))
        self.connect((self.cos_3000, 0), (self.blocks_add, 2))
        self.connect((self.cos_500, 0), (self.blocks_add, 0))
        self.connect((self.cos_5000, 0), (self.blocks_add, 3))
        self.connect((self.lpf_n1, 0), (self.qtgui_freq_sink, 1))
        self.connect((self.lpf_n1, 0), (self.qtgui_time_sink, 1))
        self.connect((self.lpf_n4, 0), (self.qtgui_freq_sink, 2))
        self.connect((self.lpf_n4, 0), (self.qtgui_time_sink, 2))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.cos_1500.set_sampling_freq(self.samp_rate)
        self.cos_3000.set_sampling_freq(self.samp_rate)
        self.cos_5000.set_sampling_freq(self.samp_rate)
        self.blocks_throttle.set_sample_rate(self.samp_rate)
        self.lpf_n1.set_taps(firdes.low_pass(1, self.samp_rate, self.cutoff, 200, window.WIN_HAMMING, 6.76))
        self.lpf_n4.set_taps(firdes.low_pass(1, self.samp_rate, self.cutoff, 50, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=exemplo_04_butterworth_ordens, options=None):
