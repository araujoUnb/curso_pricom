...
# Title: Exemplo 06 - Parseval: Energia no Tempo e Frequencia
# Author: Curso PriCom - UnB
# Description: Parseval - Energia no Tempo e Frequencia
...
class exemplo_06_parseval_energia(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Exemplo 06 - Parseval: Energia no Tempo e Frequencia", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Exemplo 06 - Parseval: Energia no Tempo e Frequencia")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "exemplo_06_parseval_energia")
        ...
        labels = ['cos(2*pi*1000*t)', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_freq_sink = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            "PSD - Distribuicao de Energia", #name
            1,
            None # parent
        )
        ...
        self.analog_sig_source = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0, 0)
...
def main(top_block_cls=exemplo_06_parseval_energia, options=None):
