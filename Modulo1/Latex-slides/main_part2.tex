...
\newcommand{\subtituloApresentacao}{Part II: Densidade Espectral, Banda Básica/Passante e DFT}
...
% Continuar numeração das seções a partir de 5
% (Part I termina na seção 5, Part II começa na 6)
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ============================================
% CONTEÚDO: PARTE II (Seções 3.6 a 3.9)
% ============================================
\input{cap3_part2}
