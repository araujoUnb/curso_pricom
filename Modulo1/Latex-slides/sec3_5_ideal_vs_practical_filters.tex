...
\begin{frame}{Tipos de Filtros Ideais}

Filtros ideais têm resposta em frequência perfeitamente seletiva:

\begin{enumerate}
\item \textbf{Passa-Baixas (Low-Pass):}
\[
...
\item \textbf{Passa-Altas (High-Pass):}
\[
...
\item \textbf{Passa-Faixas (Band-Pass):}
\[
...
\item \textbf{Rejeita-Faixas (Band-Stop):}
\[
