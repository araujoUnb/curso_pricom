...
\begin{frame}{Filtro Ideal vs Butterworth — Simulação}

\begin{center}
\includegraphics[width=\figFull, height=0.85\textheight, keepaspectratio]{figures/cap3/filtro_ideal_vs_butterworth}
\end{center}
...
\begin{frame}{Resposta ao Impulso — Ideal vs Prático}

\begin{center}
\includegraphics[width=\figFull, height=0.85\textheight, keepaspectratio]{figures/cap3/resposta_impulso_ideal_vs_pratico}
\end{center}
...
\begin{frame}{Butterworth: Características de Fase}

\textbf{Fase do filtro de Butterworth:}
\begin{itemize}
\item Fase não-linear (especialmente próximo a $\omega_c$)
\item Distorção de fase presente, mas moderada
\item Atraso de grupo não-constante: $\tau_g(\omega)$ varia com a frequência
\end{itemize}

\vspace{0.3cm}

\textbf{Compromisso do Butterworth:}
\begin{itemize}
\item Resposta em magnitude \textbf{maximalmente plana} na banda passante
\item Fase não-linear $\rightarrow$ distorção de fase inevitável
\item Para aplicações sensíveis à fase, considerar o filtro de Bessel
\end{itemize}
...
\begin{frame}{Butterworth: Efeito da Ordem — Simulação}

\begin{center}
\includegraphics[width=\figFull, height=0.85\textheight, keepaspectratio]{figures/cap3/butterworth_efeito_ordem}
\end{center}
...
\]
onde $T_n(x)$ é o polinômio de Chebyshev de ordem $n$ e $\epsilon$ controla a ondulação.
...
\begin{frame}{Comparação Completa: Magnitude, Fase e Atraso de Grupo}

\begin{center}
\includegraphics[width=\figFull, height=0.85\textheight, keepaspectratio]{figures/cap3/comparacao_filtros_completa}
\end{center}
...
% Slide antigo filters_comparison removido — substituído por comparacao_filtros_completa acima
...
\begin{frame}{Sinal Filtrado — Comparação de Filtros Práticos}

\begin{center}
\includegraphics[width=\figFull, height=0.85\textheight, keepaspectratio]{figures/cap3/sinal_filtrado_comparacao}
\end{center}
...
\begin{frame}{Resposta ao Degrau — Comparação de Filtros}

\begin{center}
\includegraphics[width=\figFull, height=0.85\textheight, keepaspectratio]{figures/cap3/resposta_degrau_filtros}
\end{center}
