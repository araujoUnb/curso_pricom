...
Modelo do cabo: $H_c(\omega) = \frac{1}{1 + j\omega/\omega_c}$ com $f_c = 15$ kHz

\textbf{Efeito:} Sons agudos ($f > 15$ kHz) são atenuados $\Rightarrow$ áudio ``abafado''
...
\textbf{É exatamente o que um equalizador de áudio faz:} ajusta ganhos em diferentes faixas de frequência para compensar as características do canal!
