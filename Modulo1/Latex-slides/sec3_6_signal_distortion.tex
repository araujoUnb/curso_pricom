...
\begin{frame}{Visualização: Distorção de Sinal}

\begin{center}
\includegraphics[width=\figFull, height=0.75\textheight, keepaspectratio]{figures/cap3/signal_distortion}
\end{center}

Magnitude não-uniforme e fase não-linear alteram a forma do sinal transmitido.
...
\textbf{Efeito multipercurso:} Sinal chega ao receptor por múltiplos caminhos com diferentes atrasos e atenuações.
...
\begin{itemize}
\item \textbf{Desvanecimento seletivo:} $|H_c(\omega)|$ varia rapidamente
\item Interferência destrutiva em certas frequências: $|H_c(\omega)| \approx 0$
