...
\end{column}
\begin{column}{0.47\textwidth}
  \textbf{O 1G era \alert{FM anal\'{o}gica} pura!}

  \vspace{0.1cm}

  O celular original (AMPS, 1983) usava exatamente a modulac\~{a}o FM que estudaremos no M\'{o}dulo 2.

  \vspace{0.1cm}

  \textbf{Conceitos desta disciplina:}
  \begin{itemize}
    \item \textbf{M\'{o}d. 1:} Espectro e filtros
    \item \textbf{M\'{o}d. 2:} AM, FM --- a base de tudo
    \item \textbf{M\'{o}d. 3:} Amostragem e digitalizac\~{a}o
  \end{itemize}
