...
class pratica_08_reconstrucao_zoh(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.time_sink = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            "Reconstrução no tempo: sinal real, ZOH e equalizado", #name
            3, #number of inputs
            None # parent
        )
        ...
        labels = ['Sinal real (ideal)', 'ZOH (escada)', 'Equalizado', 'Signal 4', 'Signal 5',
        ...
        self.src_real = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, f0, 1.0, 0, 0)
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.equalizador = equalizador.blk(fs_low=fs_low, fs_high=samp_rate, ntaps=eq_ntaps, ngrid=512)
        ...
        self.connect((self.equalizador, 0), (self.time_sink, 2))
        self.connect((self.src, 0), (self.zoh, 0))
        self.connect((self.src_real, 0), (self.time_sink, 0))
        self.connect((self.throttle, 0), (self.equalizador, 0))
        self.connect((self.throttle, 0), (self.freq_sink, 0))
        self.connect((self.throttle, 0), (self.time_sink, 1))
    ...
    def set_f0(self, f0):
        ...
        self.src_real.set_frequency(self.f0)
