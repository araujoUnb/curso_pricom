...
\begin{frame}{Companding: Curvas e Desempenho}
  \begin{columns}[T]
    ...
    \begin{center}
      \includegraphics[width=\textwidth]{figures/cap7/companding_curves}
    \end{center}
    {\scriptsize
      Curva côncava: maior resolução perto de zero,
      menor para grandes amplitudes.
      Linha tracejada = linear (sem compressão).}

    \column{0.49\textwidth}
    \textbf{SQNR: Uniforme vs.\ $\mu$-law}
    \begin{center}
      \includegraphics[width=\textwidth]{figures/cap7/companding_sqnr_comparison}
    \end{center}
    {\scriptsize
      Com $\mu$-law, o SQNR permanece quase constante
      em ampla faixa dinâmica — ideal para a voz humana.}
  \end{columns}
\end{frame}
