...
\begin{frame}{Visualização do Espectro Amostrado}
  \begin{center}
    \includegraphics[width=0.80\textwidth]{figures/cap7/sampling_spectrum}
  \end{center}
  \vspace{-0.2cm}
  {\footnotesize
...
\begin{frame}{Aliasing — Demonstração Visual}
  \begin{center}
    \includegraphics[width=0.80\textwidth]{figures/cap7/aliasing_demo}
  \end{center}
  \vspace{-0.2cm}
  {\footnotesize
...
\begin{frame}{Amostragem no Domínio do Tempo}
  \begin{center}
    \includegraphics[width=0.76\textwidth]{figures/cap7/sampling_time_domain}
  \end{center}
  {\footnotesize
